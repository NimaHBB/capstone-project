...
const CreateLoginPage = () => {
      ...
      .catch((error) => {
        ...
        switch (error.code) {
          case "auth/wrong-password":
            setAppMessage("password is wrong!");
            break;
          case "auth/user-not-found":
            setAppMessage("this email is not registered!");
            break;
          case "auth/too-many-requests":
            setAppMessage("Too many requests! Try again later.");
            break;
          default:
  ...
  return (
    <>
      ...
      <MessageBox display={messageDisplay}>
        <Message msgType={messageType}>{appMessage}</Message>
      </MessageBox>
    </>
  );
};
